...
$('#rupee1').on('click', function generate() {
  $('#rupee1random').text(Math.floor(Math.random()*(10-1+1)+1));
});
...
$('#rupee2').on('click', function generate() {
  $('#rupee2random').text(Math.floor(Math.random()*(20-11+1)+11));
});
...
$('#rupee3').on('click', function generate() {
  $('#rupee3random').text(Math.floor(Math.random()*(30-21+1)+21));
});
...
$('#rupee4').on('click', function generate() {
  $('#rupee4random').text(Math.floor(Math.random()*(40-31+1)+31));
});
